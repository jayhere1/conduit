    ...
    pub fn from_config(name: &str, config: &ConnectionConfig) -> Result<Self, ProviderError> {
        let host = config
            ...
            .ok_or_else(|| ProviderError::InvalidConfig {
                ...
                reason: "Jira requires a 'host' (e.g., mycompany.atlassian.net)".to_string(),
            })?;
...
impl SaasProvider for JiraProvider {
    ...
    async fn create(
        ...
        Ok(SaasResult {
            ...
            records_affected: 1,
            data: serde_json::json!({"type": object_type, "input": data}),
            execution_time_ms: 0,
            rate_limit: None,
            next_cursor: None,
        })
    ...
    async fn update(
        ...
        Ok(SaasResult {
            ...
            records_affected: 1,
            data: serde_json::json!({"type": object_type, "id": record_id, "input": data}),
            execution_time_ms: 0,
            rate_limit: None,
            next_cursor: None,
        })
    ...
    async fn delete(
        ...
        Ok(SaasResult {
            ...
            records_affected: 1,
            data: serde_json::json!({"type": object_type, "id": record_id}),
            execution_time_ms: 0,
            rate_limit: None,
            next_cursor: None,
        })
