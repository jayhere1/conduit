...
impl GitHubProvider {
    pub fn from_config(name: &str, config: &ConnectionConfig) -> Result<Self, ProviderError> {
        let api_url =
            extra_str(config, "api_url").unwrap_or_else(|| "https://api.github.com".to_string());
...
impl SaasProvider for GitHubProvider {
    ...
    async fn create(
        ...
        Ok(SaasResult {
            ...
            records_affected: 1,
            data: serde_json::json!({"resource": object_type, "input": data}),
            execution_time_ms: 0,
            rate_limit: None,
            next_cursor: None,
        })
    ...
    async fn update(
        ...
        Ok(SaasResult {
            ...
            records_affected: 1,
            data: serde_json::json!({"resource": object_type, "id": record_id, "input": data}),
            execution_time_ms: 0,
            rate_limit: None,
            next_cursor: None,
        })
    ...
    async fn delete(
        ...
        Ok(SaasResult {
            ...
            records_affected: 1,
            data: serde_json::json!({"resource": object_type, "id": record_id}),
            execution_time_ms: 0,
            rate_limit: None,
            next_cursor: None,
        })
